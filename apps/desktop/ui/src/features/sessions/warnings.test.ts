...
describe("describeWarning", () => {
  ...
  it.each([
    ...
    "rdp.clipboard_too_large",
    "rdp.clipboard_unavailable",
    "clipboard.local_write_failed",
    "rdp.clipboard_files_skipped",
    "rdp.clipboard_files_too_many",
    "rdp.clipboard_files_unsupported",
